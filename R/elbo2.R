...
#'
#' @examples
#' ELBO2(d=2,n=100,T0=20,shape_alpha=0.001,rate_alpha=0.001,s01=0.001,s02=0.001,X=matrix(1,nrow=100, ncol=2),L20=0.001,Mu0=matrix(c(rep(0,2)), nrow=1),W1=0.001,W2=0.001,G1=0.001,G2=0.002,V1=matrix(0.0001, nrow = 20, ncol = 1),V2=matrix(0.0001, nrow = 20, ncol = 1),L1=matrix(0.0001, nrow = 20, ncol = 2),L2=matrix(0.0001, nrow = 20, ncol = 1),Plog=matrix(-3,nrow=100,ncol=20))
ELBO2 <- function(d,n,T0,shape_alpha,rate_alpha,s01,s02,X,L20,Mu0,W1,W2,G1,G2,V1,V2,L1,L2,Plog){
  C00 <- diag(d)/L20
  W1 = W1
  W2 = W2
  G1 = G1
