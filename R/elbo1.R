...
#'
#' This function computes the ELBO for a DPMM with varied alpha and fixed sigma
#'
...
#'
#' @examples
#' ELBO1(D=2,N=100,C0=diag(2),T0=20,s1=0.001,s2=0.001,X=matrix(1,nrow=100, ncol=2),L20=0.001,Mu0=matrix(c(rep(0,2)), nrow=1),W1=0.001,W2=0.001,V1=matrix(0.0001, nrow = 20, ncol = 1),V2=matrix(0.0001, nrow = 20, ncol = 1),L1=matrix(0.0001, nrow = 20, ncol = 2),L2=matrix(0.0001, nrow = 20, ncol = 1),Plog=matrix(-3,nrow=100,ncol=20))
ELBO1 <- function(D,N,C0,T0,s1,s2,X,L20,Mu0,W1,W2,V1,V2,L1,L2,Plog){
  C00 <- diag(D)/L20
  W1 = W1
  W2 = W2
